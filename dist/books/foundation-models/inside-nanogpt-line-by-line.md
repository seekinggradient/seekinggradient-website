...
![Token IDs become embeddings, retain the same residual-stream width through Transformer blocks, and expand to vocabulary logits](../../media/transformer-foundations/11-tensor-shape-journey.png)
...
![A causal attention map allows each query position to retrieve only from itself and earlier positions](../../media/transformer-foundations/12-causal-attention-map.png)
...
![A Transformer block alternates a normalized attention update and a normalized MLP update around one persistent residual stream](../../media/transformer-foundations/10-transformer-block-workshop-illustration.png)
...
![Documents are tokenized, separated by boundary tokens, concatenated, and sliced into fixed-length training windows](../../media/transformer-foundations/13-document-packing.png)
...
![A training terminal turns the abstract loss function into iteration time, validation loss, and utilization readings](../../media/transformer-foundations/05-gpt2-training-at-35m20s.png)
